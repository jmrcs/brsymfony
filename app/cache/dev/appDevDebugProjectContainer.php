...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'createmovies' => 'getCreatemoviesService',
            ...
            'listmovies' => 'getListmoviesService',
            'listoperations' => 'getListoperationsService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \CalcBundle\Services\Calculator A CalcBundle\Services\Calculator instance.
     */
    protected function getCalculatorService()
    {
        return $this->services['calculator'] = new \CalcBundle\Services\Calculator($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'createmovies' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MovieBundle\Services\CreateMovies A MovieBundle\Services\CreateMovies instance.
     */
    protected function getCreatemoviesService()
    {
        return $this->services['createmovies'] = new \MovieBundle\Services\CreateMovies($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'brsymfonDBlxlor', 'user' => 'brsymfonDBlxlor', 'password' => 'zlI74PGBYM', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/CalcBundle/Resources/config/doctrine') => 'CalcBundle\\Entity', ($this->targetDirs[3].'/src/MovieBundle/Resources/config/doctrine') => 'MovieBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'CalcBundle\\Entity');
        $b->addDriver($a, 'MovieBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CalcBundle' => 'CalcBundle\\Entity', 'MovieBundle' => 'MovieBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c120ea9d530be06b1e2270eb17f96b71a48f09f6b4ffb5a5333d42df69d5db89');
    ...
    /**
     * Gets the 'listmovies' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MovieBundle\Services\ListMovies A MovieBundle\Services\ListMovies instance.
     */
    protected function getListmoviesService()
    {
        return $this->services['listmovies'] = new \MovieBundle\Services\ListMovies($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'listoperations' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CalcBundle\Services\ListOperations A CalcBundle\Services\ListOperations instance.
     */
    protected function getListoperationsService()
    {
        return $this->services['listoperations'] = new \CalcBundle\Services\ListOperations($this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \MovieBundle\Services\Movie A MovieBundle\Services\Movie instance.
     */
    protected function getMovieService()
    {
        return $this->services['movie'] = new \MovieBundle\Services\Movie($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt|error)|css|images|js)/'), 'security.firewall.map.context.main' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CalcBundle/Resources/views'), 'Calc');
        $instance->addPath(($this->targetDirs[3].'/src/MovieBundle/Resources/views'), 'Movie');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('06646a7d6c3e29f311e6f7d87b3407a9982420ae');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('559c9c8eab6d5')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CalcBundle' => 'CalcBundle\\CalcBundle',
                'MovieBundle' => 'MovieBundle\\MovieBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'brsymfonDBlxlor',
            'database_user' => 'brsymfonDBlxlor',
            'database_password' => 'zlI74PGBYM',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '06646a7d6c3e29f311e6f7d87b3407a9982420ae',
            ...
            'kernel.secret' => '06646a7d6c3e29f311e6f7d87b3407a9982420ae',
